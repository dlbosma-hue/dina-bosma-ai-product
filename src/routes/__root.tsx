...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI consulting by Dina Bosma-Buczynska. Strategy, implementation, and the bridge between them. Berlin." },
      { name: "author", content: "Dina Bosma-Buczynska" },
      { property: "og:title", content: "HUMINT, Human intelligence. AI powered." },
      { property: "og:description", content: "AI consulting by Dina Bosma-Buczynska. Strategy, implementation, and the bridge between them. Berlin." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "HUMINT, Human intelligence. AI powered." },
      { name: "twitter:description", content: "AI consulting by Dina Bosma-Buczynska. Strategy, implementation, and the bridge between them. Berlin." },
